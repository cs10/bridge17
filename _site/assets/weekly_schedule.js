...
$(document).ready(function() {
    ...
    $('#oh-cal').fullCalendar({
      ...
      eventSources: [
        { googleCalendarId: 'berkeley.edu_h2756o1j98vcgman1mecd6kghg@group.calendar.google.com',
          cache: true,
          className: 'lecture' },
        { googleCalendarId: 'berkeley.edu_6d1e38lj7arh67a2e83ofv0cgo@group.calendar.google.com',
          cache: true,
          className: 'lab' },
        { googleCalendarId: 'berkeley.edu_k2g60q1sehd2u0ujd257jqm7h0@group.calendar.google.com',
          cache: true,
          className: 'oh' },
        { googleCalendarId: 'berkeley.edu_gdalupo08mi8s2ivsoki82ip9c@group.calendar.google.com',
          cache: true,
          className: 'disc' }
      ]
    });
