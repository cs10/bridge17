...
cs10.startDate = '2017-06-25';
cs10.endDate   = '2017-08-06';
...
cs10.newLabObject = function(title, url, rq, video) {
    ...
    var urlEnd  = '&novideo&noreading&noassingment&course=cs10_sp17.html';
    var lab = { type: 'Lab' };
    lab.title = title;
...
function buildPerson(data, width) {
    ...
    elm = '<div class="'+ cls + '">';
    if (!!data.img) {
        elm += '<a href="/bridge17/resources/images/' + data.img + '">';
    }
